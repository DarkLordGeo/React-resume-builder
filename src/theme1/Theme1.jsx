...
function Theme1() {
    ...
    const resume =
        <>
            <div ref={printRef} className=" md:flex sm:flex-col sm:items-center sm:justify-center h-[1123px] sm:shadow-xl">
            ...
            <div className={`h-screen flex flex-col md:flex-row items-center w-max sm:h-auto md:h-[1123px] z-10 overflow-hidden `}>
                {loading
                    ...
                    <div className="h-screen sm:h-[1000px] flex flex-col md:flex-col w-auto md:w-[794px] md:h-[1123px] items-center justify-center z-10 absolute">
                        ...
                        <div className="hidden select-none md:flex sm:flex-col sm:items-center sm:justify-center sm:h-full sm:shadow-xl" >
                            <div className="flex items-center justify-center w-full px-0 py-16 bg-costum-blue ">
                                <div className="flex flex-col items-start justify-center mt-8 text-white ml-36">
                                    <div className="text-4xl font-bold ">
                                        <h1>Name Surname</h1>
                        ...
                        <h3 className={`block max-w-[250px] !my-10 md:hidden text-center font-bold  ${darkMode ? 'text-white' : 'text-dark-bg'} text-[1.5rem] sm:text-[2.5rem] sm:max-w-[450px]`}>
