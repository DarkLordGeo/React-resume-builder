...
function Theme1() {
    ...
    return (
        <>
            <div className="flex flex-col items-center justify-center  shadow-xl w-[794px] h-[1123px]  ">
                        ...
                        <div className="flex flex-col items-start justify-start w-full h-full gap-8 mt-5">
                            <div className="flex flex-col w-full">
                                <div className="flex flex-col items-start justify-start gap-3">
                                    <div className="w-full border-t-0 border-b-2 border-l-0 border-r-0 border-costum-blue">
                                        <h1 className="text-2xl font-bold tracking-widest text-costum-blue">
                                            CONTACT
                                        </h1>
                                    </div>
                            ...
                            <div className="flex flex-col w-full skillsHeader">
                                <div className="flex flex-col items-start justify-center ">
                                    <div className="w-full border-t-0 border-b-2 border-l-0 border-r-0 border-costum-blue">
                                        <h1 className="text-2xl font-bold tracking-wide text-costum-blue">
                                            SKILLS
                                        </h1>
                                    </div>
                                    <div>
                            ...
                            <div className="flex flex-col w-full Languagesr">
                                <div className="flex flex-col items-start justify-center">
                                    <div className="w-full border-t-0 border-b-2 border-l-0 border-r-0 border-costum-blue">
                                        <h1 className="w-full text-2xl font-bold tracking-wide text-costum-blue">
                                            LANGUAGES
                                        </h1>
                                    </div>
                                    <div>
