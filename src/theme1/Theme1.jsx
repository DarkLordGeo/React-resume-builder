...
function Theme1() {
    ...
    return (
        <>
            ...
            <div className={`flex flex-row items-center h-screen w-max sm:h-[1123px]`}>
                {loading
                    ?
                    <div>
                        <h3 className={`text-[2rem] mb-20 ${darkMode ? 'text-white' : 'text-dark-bg'} mt-20 sm:text-[5rem] text-center font-bold `}>Loading</h3>
                        <SyncLoader
