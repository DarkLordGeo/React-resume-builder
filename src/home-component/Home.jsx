...
<>
  ...
  <main className="flex flex-col items-center w-full gap-16 pt-24 pb-24 md:justify-center dark:bg-gray-900 dark:text-white">
    ...
    <div
      className="min-[320px]:px-5 min-[320px]:py-4 flex flex-row items-center justify-center gap-16 p-10 m-auto text-xl shadow-xl rounded-xl lg:w-4/5 md:w-4/5 min-[320px]:flex-col md:flex-row min-[320px]:gap-10 min-[320px]:w-4/5 min-[320px]:text-lg opacity-0 transition-opacity duration-1000 dark:bg-gray-800 dark:text-white dark:shadow-xl"
      id="mainContent"
      style={{
        opacity:opacity,
